  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    if (isNaN(attempts) || attempts === 0) {
      toast({
        title: "Error.",
        description:
          "Invalid score format. Attempts must be a number greater than 0.",
        status: "error",
        duration: 9000,
        isClosable: true,
      });
  ...
  return (
    ...
    >
      <HStack spacing={8} direction={"row"}>
        ...
        <FormControl>
          <FormLabel htmlFor="score">Attempts</FormLabel>
          <Select
            id="score"
            value={score}
        ...
        <Button type="submit" colorScheme="whatsapp" marginTop="8" size={"lg"}>
          Submit
        </Button>
      </HStack>
    </Box>
